      ...
      <div className="relative z-10 bg-[#FAFAFA] shadow-[0_45px_100px_rgba(0,0,0,0.55)]">
        ...
        >
          ...
          <div className="max-w-[1366px] mx-auto text-center flex flex-col items-center">
            {/* Breadcrumb */}
            <div className="hero-anim flex items-center gap-2 text-[12px] text-zinc-400 mb-6 bg-white/[0.05] border border-white/10 px-4 py-1.5 rounded-full font-mono font-normal">
            ...
            <div className="hero-anim inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#00D28F]/20 border border-[#00D28F]/40 text-[#00D28F] text-[14px] font-normal font-mono mb-6">
              <Sparkles className="w-4 h-4" />
              <span>{service.category}</span>
            </div>

            {/* Strictly H1 (5xl md:7xl) */}
            <h1 className="hero-anim text-5xl md:text-7xl font-bold tracking-tight text-white font-sans max-w-5xl leading-[1.08] mb-6">
            ...
            {/* Large Body Tier */}
            <p className="hero-anim text-[20px] md:text-[24px] text-zinc-300 font-normal max-w-3xl leading-relaxed mb-10">
            ...
            <div className="hero-anim flex flex-col sm:flex-row items-center gap-4">
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-full font-bold text-[14px] uppercase tracking-wider text-[#0A0A0A] bg-[#00D28F] hover:bg-[#00B87D] shadow-xl shadow-[#00D28F]/25 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
                <span>Book Service Discovery Call</span>
                <ArrowUpRight className="w-4 h-4" />
              </button>

              <div className="flex items-center gap-2 px-5 py-3 rounded-full bg-white/[0.06] border border-white/10 text-[14px] font-mono font-normal text-[#00D28F]">
                <span>Verified Impact:</span>
                <span className="text-white font-bold">{service.metrics}</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white border-b border-zinc-200">
          <div className="max-w-[1366px] mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-[14px] font-normal font-mono text-zinc-400 block mb-2">
                Strategic Diagnosis
              </span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="p-6 sm:p-8 rounded-2xl bg-rose-50/50 border border-rose-200/80">
                <div className="flex items-center gap-2.5 text-rose-800 text-[14px] font-mono font-normal mb-6">
                  <XCircle className="w-4 h-4 text-rose-600" />
                  <span>The Industry Bottlenecks</span>
                </div>
                <div className="space-y-4">
                  {service.problemStatement.map((prob, idx) => (
                    <div key={idx} className="flex items-start gap-3 text-[14px] md:text-[16px] text-zinc-700 font-normal">
              ...
              <div className="p-6 sm:p-8 rounded-2xl bg-emerald-50/50 border border-emerald-300/80 shadow-lg shadow-emerald-500/5">
                <div className="flex items-center gap-2.5 text-[#00A870] text-[14px] font-mono font-normal mb-6">
                  <CheckCircle2 className="w-4 h-4 text-[#00A870]" />
                  <span>The Startuplize Solution</span>
                </div>
                <div className="space-y-4">
                  {service.solutionStatement.map((sol, idx) => (
                    <div key={idx} className="flex items-start gap-3 text-[14px] md:text-[16px] text-zinc-800 font-normal">
          ...
          <div className="max-w-[1366px] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {service.deliverables.map((item, idx) => (
                <div
                  key={idx}
                  className="p-6 rounded-2xl bg-white border border-zinc-200 shadow-sm hover:border-[#00D28F] hover:shadow-xl transition-all duration-300 flex items-start gap-4"
                >
                  <div className="w-8 h-8 rounded-xl bg-[#00D28F]/15 flex items-center justify-center shrink-0 mt-0.5">
                    <CheckCircle2 className="w-4 h-4 text-[#00A870]" />
                  </div>
                  <div>
                    <h3 className="text-[16px] font-bold text-[#1A1A1A] mb-1 font-sans">
                      {item}
                    </h3>
                    <p className="text-[14px] text-zinc-500 font-normal">
        ...
        <section
          ref={pinTriggerRef}
          className="py-20 px-4 sm:px-6 lg:px-8 bg-white border-b border-zinc-200 relative"
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              <div className="lg:col-span-5 pinned-timeline-header self-start">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-100 border border-zinc-200 text-zinc-800 text-[14px] font-normal font-mono mb-4">
                  <Clock className="w-4 h-4 text-[#00B87D]" />
                  <span>Sprint Timeline</span>
                </div>

                {/* Strictly H2 (text-3xl md:text-5xl) */}
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-[#1A1A1A] font-sans mb-6">
                  Our 4-Phase{" "}
                  <span className="font-serif italic font-normal text-[#00B87D]">
                    Execution Sprint.
                  </span>
                ...
                <button
                  onClick={() => setIsBookingOpen(true)}
                  className="px-8 py-4 rounded-full font-bold text-[14px] uppercase tracking-wider text-[#0A0A0A] bg-[#00D28F] hover:bg-[#00B87D] shadow-lg shadow-[#00D28F]/25 hover:scale-105 active:scale-95 transition-all cursor-pointer"
                >
              ...
              <div className="lg:col-span-7 space-y-6">
                {service.timeline.map((step) => (
                  <div
                    key={step.step}
                    className="p-6 sm:p-8 rounded-2xl bg-[#FAFAFA] border border-zinc-200/90 shadow-sm hover:border-[#00D28F] hover:shadow-xl transition-all"
                  >
                    <div className="flex items-center justify-between gap-4 mb-3">
                      <span className="text-[12px] font-mono font-normal text-[#00A870] px-3 py-1 rounded-full bg-[#00D28F]/15">
                        PHASE {step.step}
                      </span>
                      <span className="text-[12px] font-normal text-zinc-500 font-mono">
                        {step.duration}
                      </span>
                    </div>
          ...
          <div className="flex overflow-hidden">
            <div className="flex shrink-0 items-center gap-6 animate-marquee">
              {service.techStack.concat(service.techStack).concat(service.techStack).map((tool, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-2.5 px-6 py-3 rounded-full bg-white/[0.05] border border-white/10 text-[14px] font-normal text-zinc-200 font-mono"
                >
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#FAFAFA] border-b border-zinc-200">
          <div className="max-w-[1366px] mx-auto">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-14 gap-6">
              ...
              <Link
                href="/portfolio"
                className="inline-flex items-center gap-1.5 text-[14px] font-bold uppercase tracking-wider text-[#00B87D] hover:text-[#0A0A0A] hover:scale-105 active:scale-95 transition-all"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {service.caseStudies.map((study, idx) => (
                <div
                  key={idx}
                  className="group rounded-2xl bg-white border border-zinc-200/90 overflow-hidden shadow-sm hover:border-[#00D28F] hover:shadow-2xl transition-all duration-500"
                >
                  <div className="relative aspect-[16/10] w-full overflow-hidden bg-zinc-900">
                    ...
                    <div className="absolute bottom-5 left-5 right-5">
                      <span className="text-[12px] font-normal font-mono text-[#00D28F] block mb-1">
                        {study.client}
                      </span>
                  ...
                  <div className="p-6 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="text-[12px] font-normal font-mono text-zinc-500">
                        Result:
                      </span>
                      <span className="text-[14px] font-mono font-bold text-[#00B87D]">
                        {study.result}
                      </span>
                    </div>
                    ...
                    <Link
                      href="/portfolio"
                      className="p-2 rounded-full bg-zinc-100 group-hover:bg-[#00D28F] hover:scale-105 active:scale-95 transition-all"
                    >
          ...
          <div className="max-w-[1366px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {service.testimonials.map((test, idx) => (
                <div
                  key={idx}
                  className="p-6 sm:p-8 rounded-2xl bg-[#FAFAFA] border border-zinc-200/90 shadow-sm flex flex-col justify-between"
                >
                  <div>
                    ...
                    {/* Small Body Tier */}
                    <p className="text-[14px] md:text-[16px] text-zinc-700 italic font-normal leading-relaxed mb-6">
