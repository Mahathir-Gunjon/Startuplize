      ...
      <footer className="bg-[#0A0A0A] text-[#FAFAFA] pt-20 pb-0 border-t border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-[1366px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pb-12 mb-16 border-b border-white/10 flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-[14px] text-zinc-400 font-mono">
          ...
          {/* 12-Column Grid: 4-Column Navigation & Contact Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 pb-16 border-b border-white/10">
            {/* Column 1: Brand & Newsletter (4 cols) */}
            <div className="lg:col-span-4 flex flex-col items-start">
              <Link href="/" className="flex items-center gap-2.5 mb-6 group">
                <div className="w-8 h-8 rounded-lg bg-[#00D28F] flex items-center justify-center shadow-lg shadow-[#00D28F]/25 group-hover:scale-105 transition-transform">
              ...
              {/* Small Body Tier */}
              <p className="text-[14px] md:text-[16px] text-zinc-400 font-normal leading-relaxed mb-6 max-w-sm">
              ...
              <div className="w-full max-w-sm">
                ...
                <form onSubmit={handleSubscribe} className="relative flex items-center">
                  <input
                    ...
                    required
                    className="w-full pl-4 pr-28 py-3 rounded-full bg-white/[0.05] border border-white/15 text-[14px] text-white placeholder:text-zinc-500 focus:outline-none focus:border-[#00D28F] transition-colors"
                  />
                  <button
                    type="submit"
              ...
              <ul className="space-y-3 text-[14px] md:text-[16px] text-zinc-400">
                {[
                  ...
                  <li key={item.name}>
                    ...
                    >
                      <span>{item.name}</span>
                      <ArrowUpRight className="w-3.5 h-3.5 text-[#00D28F] opacity-0 hover:opacity-100 transition-opacity" />
                    </Link>
                  </li>
                ))}
              </ul>
            ...
            <div className="lg:col-span-3 space-y-6">
              <div>
                ...
                <p className="text-[14px] md:text-[16px] text-zinc-300 flex items-start gap-2">
                  <MapPin className="w-4 h-4 text-[#00D28F] shrink-0 mt-1" />
              ...
              <div>
                ...
                <a
                  ...
                  className="text-[14px] md:text-[16px] text-white font-medium hover:text-[#00D28F] transition-colors block"
                >
                  hello@startuplize.com
                </a>
                <a
                  href="tel:+18005557827"
                  className="text-[14px] text-zinc-400 hover:text-white transition-colors block mt-1 font-mono"
                >
                  +1 (800) 555-START
                </a>
              </div>
                  ...
                  {[
                    ...
                    return (
                      <a
                        ...
                        aria-label={s.label}
                        className="w-8 h-8 rounded-full bg-white/[0.06] border border-white/10 hover:border-[#00D28F] hover:bg-[#00D28F]/20 text-zinc-300 hover:text-[#00D28F] flex items-center justify-center transition-all"
                      >
          ...
          <div className="pt-8 pb-4 flex flex-col sm:flex-row items-center justify-between gap-6 text-[14px] text-zinc-500 font-mono">
