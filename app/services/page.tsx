          ...
          <div className="max-w-[1366px] mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {SERVICES.map((service, idx) => (
                <div
                  key={service.slug}
                  className="group rounded-2xl bg-white border border-zinc-200 shadow-sm hover:border-[#00D28F] hover:shadow-2xl transition-all duration-300 p-8 flex flex-col justify-between"
                >
                  <div>
                    <div className="flex items-center justify-between gap-4 mb-6">
                      <span className="px-3 py-1 rounded-full bg-[#00D28F]/15 text-[#00A870] font-mono text-[12px] font-normal">
                        {service.category}
                      </span>
                  ...
                  <div className="pt-6 border-t border-zinc-100 flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="px-5 py-2.5 rounded-full font-bold text-[14px] uppercase tracking-wider text-[#0A0A0A] bg-[#00D28F] hover:bg-[#00B87D] hover:scale-105 active:scale-95 transition-all flex items-center gap-1.5"
                    >
